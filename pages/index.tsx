...
// Note : SSR can only be done on pages and not in components
const Home = ({
  netflixOriginals,
  trendingNow,
  topRated,
  ...
  const trendingMovieList:movieList[] = [
  {
    title:"Trending Now",
    movies:trendingNow
  },
    ...
    <div className="relative h-screen bg-gradient-to-b from-gray-900/10 to-[#010511] lg:h-[140vh]">
      ...
      <main className='relative pb-24 pl-4 lg:space-y-24 lg:pl-16'>
        ...
        <section className='md:space-y-24'>
          {trendingMovieList.map((list)=>{
            return <Row title={list.title} movies={list.movies}/> 
          })}
